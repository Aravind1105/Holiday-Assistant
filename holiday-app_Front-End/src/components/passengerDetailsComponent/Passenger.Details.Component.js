...
import './Passenger.Details.Component.css';
...
class PassengerDetails extends Component {
    ...
    handleChange(e) {
        e.preventDefault();
        if (["firstName", "lastName", "age", "nationality", "passportNo"].includes(e.target.className)) {
            console.log("IF");
    ...
    next(e) {
        ...
        sessionStorage.setItem("FlightUserDetails", JSON.stringify(this.state.pgr));
        window.location.href = "/confirmFlight";
    }
    render() {
        let { pgr } = this.state;
        return (
                    ...
                    <div className="col-sm-9 col-md-7 col-lg-5 mx-auto my-5">
                        <div className="card" >
                            <div className="card-body" id="form-users">
                                <h5 className="card-header text-center">Passenger Details</h5>
                                            ...
                                            return (
                                                <div key={idx}>
                                                    ...
                                                    <div className="form-label-group">
                                                        ...
                                                        />
                                                        <label htmlFor={ppId}>PassportNo</label>
                                                    </div>
                                                </div>
                                            )
                                        })
